...
abstract class AbstractDatabaseDriver implements DatabaseDriverInterface
{
    ...
    public function __construct(ContainerBuilder $container, $prefix, $resourceName, $templates = null, $rolePrefix = null)
    {
    ...
    protected function getConfigurationDefinition()
    {
        ...
        $definition
            ...
            ->setArguments(array($this->prefix, $this->resourceName, $this->templates, $this->rolePrefix))
            ->setPublic(false)
        ;
